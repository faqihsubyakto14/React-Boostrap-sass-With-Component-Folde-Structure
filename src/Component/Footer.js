                ...
                <div className="row g-4">
                    ...
                    <div className="col-lg-6 col-12 d-flex flex-column justify-content-center">
                        <div className="info-footer">
                            <span className="info-footer__note">
                                What They Say
                            </span>
                            <h1 className="info-footer__title">what our customer
                                say about us</h1>
                            <p className="info-footer__desc">
                            ...
                            <div className="info-footer__TravProfile d-flex">
                                ...
                                <div className='d-flex flex-column ms-3'>
                                    <div className='d-flex data align-items-baseline'>
                                        ...
                                        <p className="action">• Backpackers</p>
                                    </div>
                            ...
                            <div className="info-footer__btn">
                                <button type="button" class="btn btn-primary">All Stories</button>
                            </div>
                        </div>
                    </div>
                </div>
